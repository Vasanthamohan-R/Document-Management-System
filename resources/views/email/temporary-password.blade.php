        ...
        <div class="email-card">
            ...
            <div class="banner">
                <div class="icon-circle" style="border: none; box-shadow: 0 0 0 4px #F8F8FC; padding:10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 24 24" fill="none" stroke="#E64040" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="content">
                ...
                <p>Hi {{ $user->name }},</p>
                <p>Your account has been created successfully. Please use the temporary password below to log in to the Document Management System. You will be required to change your password upon first login.</p>

                <div class="action-container">
                    <div class="action-button">{{ $temporaryPassword }}</div>
                </div>

                <p><strong>Email:</strong> {{ $user->email }}</p>
                <p><strong>Login URL:</strong> <a href="{{ $loginUrl }}" style="color: #E64040;">{{ $loginUrl }}</a></p>
                
                <p><strong>Important Instructions:</strong></p>
                <ul style="color: #4A5568; font-size: 14px; line-height: 1.6;">
                    <li>This is a temporary password. You will be required to change it upon first login.</li>
                ...
                <div class="action-container" style="margin-top: 20px;">
                    <a href="{{ $loginUrl }}" class="action-button" style="background-color: #E64040; text-decoration: none; display: inline-block;">Login Now</a>
                </div>
            </div>
            ...
            <div class="footer">
                <div class="social-icons">
                    ...
                    <svg viewBox="0 0 24 24" width="26" height="26" fill="#FFFC00">
                        ...
                        <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-18c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm4.4 12.3c-.31-.38-1.12-.59-2.05-.62-.05 0-.1-.01-.14-.01l-.22-.01c.21-.19.46-.46.66-.75.36-.51.52-1.03.52-1.54 0-.49-.19-.94-.52-1.28-.62-.64-1.74-1.06-3.13-1.13v-.01c1.23-.33 2.11-.84 2.11-1.35 0-.54-1.06-1.02-2.52-1.02H11.9c-1.46 0-2.52.48-2.52 1.02 0 .5.88 1.02 2.11 1.35v.01c-1.4.07-2.52.49-3.13 1.13-.34.34-.52.79-.52 1.28 0 .5.15 1.03.51 1.54.21.28.46.56.67.75l-.22.01c-.04 0-.09.01-.14.01-.93.03-1.74.24-2.05.62-.27.32-.42.75-.42 1.18 0 .5.2 1.02.6 1.48.51.6 1.37.98 2.37 1.05.47.03 1.01.05 1.62.05s1.15-.02 1.62-.05c1-.07 1.86-.45 2.37-1.05.4-.46.6-1.02.6-1.48 0-.43-.16-.86-.43-1.18z" fill="#333" />
                    </svg>
