  ...
  ({ className, title, subtitle, icon: Icon, footer, headerAction, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'rounded-xl border border-slate-200 bg-white text-slate-950 shadow-sm transition-all hover:shadow-md dark:border-slate-800 dark:bg-slate-900/50 dark:backdrop-blur-sm dark:text-slate-50',
          className
        )}
        {...props}
      >
