        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              variant === 'default' && 'h-10 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 dark:border-slate-800 dark:bg-slate-900/80 dark:text-white dark:focus-visible:ring-blue-500',
              variant === 'underlined' && 'h-9 border-b border-slate-200 bg-transparent px-0 py-1 text-base focus-visible:border-blue-600 transition-all dark:border-slate-800 dark:text-white dark:focus-visible:border-blue-500 rounded-none shadow-none',
              variant === 'filled' && 'h-11 rounded-sm border-none bg-blue-50/50 px-3 py-2 text-sm focus-visible:ring-1 focus-visible:ring-blue-200 transition-all dark:bg-blue-900/30 dark:text-white dark:focus-visible:ring-blue-800',
